...
public abstract class Packet {
	...
	public static int MOTOR = 0, TOUCH = 1, ULTRASONIC = 2, COLOR = 3, HT_COLOR = 4, HT_COMPASS = 5, LIGHT = 6;
	public static int PORT_1 = 1, PORT_2 = 2, PORT_3 = 3, PORT_4 = 4, PORT_A = 5, PORT_B = 6, PORT_C = 7;
	...
	/**
	 * Returns the port that is encoded in the devicePortCode. The port code is the last 3 bits of the 8 bit
	 * devicePortCode. (ie devicePortCode & 0x7).
	 * @param devicePortCode Code to decode
	...
	/**
	 * Returns the device that is decoded from the devicePortCode. The device code is the first 5 bits (out of 8 bits)
	 * of the devicePortCode (0xf9).
	 * @param devicePortCode Encoded device and port code.
